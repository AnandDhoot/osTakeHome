...
// returned by read.
 int decrypt12(unsigned char *ciphertext, int ciphertext_len, unsigned char *key,
...
decrypt12(temp, size, key, iv,buf);
...
// documentation for the write() system call.
 int encrypt12(const char *plaintext, int plaintext_len, unsigned char *key,
	     ...
	     struct fuse_file_info *fi)
{
  ...
  /* Encrypt the plaintext */
    encrypt12(buf,size , key, iv,temp);
    printf("%s\n",buf );
printf("%s\n",temp );
  /* Clean up */
  EVP_cleanup();
